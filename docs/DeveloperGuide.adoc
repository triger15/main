= SuperTA Level 4 - Developer Guide
...
.. Prerequisites: Have one tutorial group with an ID of `04a`, an attendance session with name of `W4 Tutorial` and a student with a student ID of `A0166733Y` in the tutorial group. +
...
.. Test case: `mark-attendance tg/04a n/W4 Tutorial st/A123456T` +

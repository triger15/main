...
Format: `create-assignment tg/TUTORIAL-GROUP-ID n/ASSIGNMENT-TITLE m/MAX_MARKS`
...
Creates an assignment titled `lab1` for the tutorial group with an ID of `04a`, with the maximum marks for this assignment as `40`.
...
* *View Attendance*: `view-session tg/TUTORIAL-GRUOP-ID n/SESSION-NAME` +

...
Format: `create-tutorial-group n/NAME id/TUTORIAL_GROUP_ID`
****
...
Updates a tutorial group's details. +
Format: `update-tutorial-group id/TUTORIAL_GROUP_ID n/NAME`
...
The `MAX_MARKS` argument takes in any valid floating point number. +
...
Updates an existing assignment details. +

Assignment details such as assignment title and maximum marks can be changed with this command. +
...
* *Update Tutorial Group*: `update-tutorial-group id/TUTORIAL_GROUP_ID n/NAME` +

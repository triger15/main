...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        expectedModel.updatePerson(model.getFilteredPersonList().get(0), editedStudent);
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new UserPrefs());
        expectedModel.updatePerson(lastStudent, editedStudent);
        expectedModel.commitAddressBook();
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        EditCommand editCommand = new EditCommand(INDEX_FIRST_PERSON, descriptor);
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new UserPrefs());
        expectedModel.updatePerson(studentToEdit, editedStudent);
        expectedModel.commitAddressBook();
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonEdited() throws Exception {
        ...
        assertNotEquals(model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased()), studentToEdit);

...
public class SelectCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        Index lastPersonIndex = Index.fromOneBased(model.getFilteredStudentList().size());
    ...
    public void execute_invalidIndexFilteredList_failure() {
        ...
        assertTrue(outOfBoundsIndex.getZeroBased() < model.getSuperTaClient().getStudentList().size());

...
public class PersonListPanelHandle extends NodeHandle<ListView<Student>> {
    ...
    private Optional<Student> lastRememberedSelectedPersonCard;

    public PersonListPanelHandle(ListView<Student> personListPanelNode) {
    ...
    private Student getPerson(int index) {
